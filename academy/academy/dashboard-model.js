(function (root, factory) {
  ...
  function activityPercent(record) { return Math.round(Object.values(activityState(record)).filter(Boolean).length / activityOrder.length * 100); }
