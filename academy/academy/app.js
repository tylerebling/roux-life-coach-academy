...
function renderDashboard(){
  ...
  const dashboardActivityIcons={presentation:'<svg viewBox="0 0 32 32"><path d="M5 7h22v19H5Z"/><path d="M9 10c3 0 5 1 7 3 2-2 4-3 7-3v12c-3 0-5 1-7 3-2-2-4-3-7-3Z"/></svg>',workbook:'<svg viewBox="0 0 32 32"><path d="M8 7h16v20H8Z"/><path d="M12 4h8v6h-8Zm0 11h8m-8 4h8m-8 4h5"/></svg>',practice:'<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="10"/><circle cx="16" cy="16" r="6"/><circle cx="16" cy="16" r="2"/><path d="m18 14 8-8m-4 0h4v4"/></svg>',quiz:'<svg viewBox="0 0 32 32"><circle cx="16" cy="16" r="11"/><path d="M12 12c0-3 2-5 5-5s5 2 5 5c0 4-5 4-5 8m0 5h.01"/></svg>'};
